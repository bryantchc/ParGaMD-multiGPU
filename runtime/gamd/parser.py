    ...
    for integrator_tag in tag:
        if integrator_tag.tag == "algorithm":
            ...
            for number_steps_tag in integrator_tag:
                ...
                elif number_steps_tag.tag == "extension-steps":
                     integrator_config.number_of_steps.extension_steps = assign_tag(number_steps_tag, int)
                     #print(f"DEBUG: Parsed extension-steps = {integrator_config.number_of_steps.extension_steps}")
    ...
    def parse_file(self, filename):
        ...
        for tag in root:
            if tag.tag == "temperature":
                ...
                print(f"Integrator configuration: {self.config.integrator.number_of_steps.extension_steps}")       
        ...
        #print(f"DEBUG: Computed total_simulation_length = {self.config.integrator.number_of_steps.total_simulation_length}")
        return
